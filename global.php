...
define('__google_fonts', "https://fonts.googleapis.com/css");   
  ...
  // envio de correo
define('__mail_Username', "fe@dialcomcr.com");  
define('__mail_Password', "dialcom@");  
define('__mail_SMTPSecure', "tls");  
define('__mail_Port', 587);  
define('__mail_Domine', "://mail.dialcomcr.com:");  
