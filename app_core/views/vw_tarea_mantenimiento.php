...
*/
  if(isset($_POST['botonVer']) or isset($_POST['botonEditar']) or isset($_POST['botonEliminar'])){
    //require_once(__CTR_PATH . "ctr_tareas.php");
    //$ctr_tareas = new ctr_tareas();
    //$ctr = $ctr_tareas->buscar_Usuarios();
            ...
            <div class="form">
              <form class="form-validate form-horizontal" id="feedback_form" method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>">
                ...
                <div class="form-group ">
                  ...
                  <div class="col-lg-10">
                    <input class="form-control" placeholder="Minutos" type="number" min="1" maxlength="2"  id='tareaMinutos'  max="99" name='tareaMinutos'>
                  </div>
                </div>
                ...
                <div class="form-group ">
                  ...
                  <div class="col-lg-10">
                    <input class="form-control" placeholder="Horas" type="number" maxlength="2" min="1" id='tareaHoras'  max="99" name='tareaHoras'>
                  </div>
                </div>
